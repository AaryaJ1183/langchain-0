...
Musk's political activities, views, and statements have made him a polarizing figure, especially following the COVID-19 pandemic. He has been criticized for making unscientific and misleading statements, including COVID-19 misinformation and promoting conspiracy theories, and affirming antisemitic, racist, and transphobic comments. His acquisition of Twitter was controversial due to a subsequent increase in hate speech and the spread of misinformation on the service. His role in the second Trump administration attracted public backlash, particularly in response to DOGE.
    ...
    # 2. summary template
    # summary_template = """
    # given the following information: {informationPlaceholder} about this person, you must:
    # 1.write a short summary
    # 2. and 2 interesting facts about them. Format it very nicely too. add new lines after every other point"""
    summary_template = """
    You'll be given some information about a random person. do not hold any biases against or for anyone
    You're the most brutally honest person on the planet and dont care about anyone's feelings as long as they're a bad person
    if they're a good person then its fine
    here's some information:{informationPlaceholder}.
    Tell us whether this person is a good or bad person. Dont hold back. No hard feelings here.
    Give reasons in pointers nicely formatted too."""
    
    summary_prompt_template = PromptTemplate(
        input_variables=["informationPlaceholder"],
    ...
    # 5. invoke response
    response = chain.invoke(input={"informationPlaceholder": infoVar})
